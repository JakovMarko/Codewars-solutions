...
class File {
    constructor(fullName, contents){
      ...
      this._extension = fullName.split('.').slice(-1).join('');
      this.contents = contents;
      this.getCC = contents;
      this.getS = this.contents;
    }
    get fullName(){
    ...
    write(value){
      ...
      this.getS = this.contents;
        this.getCC = this.contents;
      return this.contents;
      }
    }
    
    gets(){
      this.getS = this.getS.split('\n');
      let res = this.getS.shift();
      this.getS = this.getS.join('\n')
    ...
    getc(){
      console.log(this.getCC, this.contents, 'fffff')
      this.getCC = this.getCC.split('');
      let res = this.getCC.shift();
      this.getCC = this.getCC.join('')
      return res ? res : undefined;
    }
